...
## Note
The Dockerfile used to build the image that docker-compose.yml will take into account, is also included. As base image an golang-alpine one is used which is light weight. My image name is eefth/my-go-app and it is pushed as a public image in Docker hub.
